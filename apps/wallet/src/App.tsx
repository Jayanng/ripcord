...
export function App() {
  ...
  return <Layout tab={tab} onTabChange={setTab}>
    ...
    <div className={`phase11-grid mobile-tab-${tab}`}><div className="primary-stack"><div className="mobile-balance"><BalanceHero /></div><div className="mobile-ripcord"><RipcordPanel /></div><div className="mobile-send"><WhatYouDontManage /></div></div><div className="secondary-stack"><div className="mobile-activity"><ActivityFeed /></div><div className="desktop-absence"><WhatYouDontManage /></div></div></div>
  </Layout>;
}
